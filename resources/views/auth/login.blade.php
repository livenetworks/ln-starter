	...
	<div class="auth-page__inner">
		...
		<div class="auth-card">
			<div class="auth-card__body">
				...
				<p class="auth-card__subtitle">{{ __('Enter your email to receive a sign-in link and six-digit code') }}</p>
				...
				<form method="post" action="{{ route('login.magic-link') }}" class="auth-form" novalidate>
					...
					<div class="auth-form__group">
						...
						<p class="auth-form__hint">
							...
							{{ __("We'll send a secure link and code to your email") }}
						</p>
					</div>
